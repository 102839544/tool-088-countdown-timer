...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 倒计时工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "countdown-timer".lower() or "clock" in "countdown-timer".lower():
            self.setup_timer_ui(main)
        elif "random" in "countdown-timer".lower() or "dice" in "countdown-timer".lower() or "coin" in "countdown-timer".lower():
            self.setup_random_ui(main)
        elif "note" in "countdown-timer".lower() or "todo" in "countdown-timer".lower():
    ...
    def generate_random(self):
        if "dice" in "countdown-timer".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "countdown-timer".lower():
